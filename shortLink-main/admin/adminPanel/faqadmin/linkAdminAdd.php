                                    ...
                                    <div id='container'>
                                        <form method='POST' > 
                                            ...
                                            <input type='text' id='' style='position:absolute; width: 0px; height: 0px; margin-left: -300px;' name='inn2' value='".$val_original."' />
                                                <input type=text class='form-control' name='inn3' style='  padding:20px 5px 20px 258px; font-weight:100em; width:100%;' placeholder='Custom Link Name' id='inn3' required />
